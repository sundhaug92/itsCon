...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:ChangePassword runat="server" ID="ChangeUserPassword" CancelDestinationPageUrl="~/"
            ...
            <fieldset class="changePassword">
                ...
                <ol>
                    <li>
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="CurrentPassword" CssClass="field-validation-error"
                    ...
                    <li>
                        ...
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="NewPassword" CssClass="field-validation-error"
